...
if __name__ =='__main__':
    ...
    p = int('21836daa1303ca11',16)
    # c = int('d03a4ceb56440a75',16)
    key = int('01192ae0dc1290a',16)
    print('\nciphertext is:' + DES(p,key,mode))
    # print('\nciphertext is:' + DES(c, key, mode))